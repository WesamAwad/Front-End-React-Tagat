        ...
        >
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-[#aaa]">{part.subtitle}</p>
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            {part.isAvailable ? (
              <span className="rounded-full bg-[#10b981] px-2.5 py-1 text-[11px] font-semibold text-white">
                متوفر
              </span>
            ) : (
              <span className="rounded-full bg-gray-400 px-2.5 py-1 text-[11px] font-semibold text-white">
                غير متوفر
              </span>
            )}
          </div>
